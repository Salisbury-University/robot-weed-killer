...
#include <TinyGPS++.h> // module for gps
#include "NewPing.h"
...
static const int TXPin = 45, RXPin = 44; // gps pins CHANGE -------//
...
void gpsCheck(){
  ...
  if (millis() > 5000 && gps.charsProcessed() < 10){
    bluetooth.println(F("No GPS detected: check wiring."));
    while(true);
    }
}
void displayInfo(){
